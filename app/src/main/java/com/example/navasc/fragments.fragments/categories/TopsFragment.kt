...
//
//@AndroidEntryPoint
//class TopsFragment:BaseCategoryFragment() {
//
//    @Inject
//    lateinit var firestore: FirebaseFirestore
//
//    val  viewModel by viewModels<CategoryViewModel> {
//        BaseCategoryViewModelFactory(firestore, Category.Tops)
//    }
...
class TopsFragment : BaseCategoryFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
       ...
       // viewModel = CategoryViewModel(BaseCategoryViewModelFactory(firestore, Category.Tops))
